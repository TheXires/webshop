<?php
  ...
  // Wenn Nutzer nicht eingeloggt ist, wird er auf Loginseite weitergeleitet
  // Pfadangabe ohne '../', da Dokument in PHP/HTML Datei eingebunden wird
  ...
  // Tritt ein Fehler auf, wird auf Loginseite weitergeleitet (Fehler: sqlerror)
  ...
  // speichert Informationen aus des Kontos in Variablen,
  // auf die durch require in ../profile.php zugegriffen werden kann
